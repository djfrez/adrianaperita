...
- **Pendente, como no SEO-033:** conferência de renderização contra a URL publicada, a 1280 px e 375 px, **depois do push** — e com `innerWidth` conferido antes de ler qualquer medida.
...
2. **Conferir `/laudo-pericial/` e `/pericia-ambiental/` no navegador contra a URL publicada**, a 1280 px e 375 px, **fixando o viewport e conferindo que `innerWidth` bateu antes de ler qualquer medida**. Duas pendências acumuladas.
