...
3. **Confirmar os dois cliques de 10/08 no Search Console** quando a série passar de 09/08, e ver **por qual consulta** entraram. É o primeiro dado real de intenção convertida do site — vale mais que qualquer estimativa de CTR. Se a consulta não constar da lista de 8 já conhecidas, ela entra direto na decisão de conteúdo.
